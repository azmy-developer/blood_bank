...
class CreateForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('client_fav_post', function(Blueprint $table) {
	...
	public function down()
	{
		...
		Schema::table('client_fav_post', function(Blueprint $table) {
			$table->dropForeign('client_fav_post_client_id_foreign');
		});
		Schema::table('client_fav_post', function(Blueprint $table) {
			$table->dropForeign('client_fav_post_post_id_foreign');
		});
		Schema::table('donation_requests', function(Blueprint $table) {
